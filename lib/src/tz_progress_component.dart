...
/// will take.
@Component(
  selector: 'tz-progress',
  templateUrl: 'tz_progress_component.html',
  styleUrls: ['tz_progress_component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
)
class TzProgressComponent implements AfterViewInit, OnDestroy {
  ...
  void _tryFancyAnimation() {
    ...
    _primaryAnimation =
        primaryIndicator.animate(primaryKeyframes, _indeterminateTiming);
    _secondaryAnimation =
